...
# Split at the main return:
# We know the main return is around line 137 and looks like "  return (" followed by "<header"
idx = content.rfind("  return (")
header = content[:idx]
return_stmt = content[idx:]

# The rest is the same string as before...
