...
class TestParseTitleHashtags(unittest.TestCase):
    """Tests for :func:`gui.llm_utils.parse_title_hashtags`."""

    def test_both_title_and_hashtags(self) -> None:
    ...
    def test_only_title_line(self) -> None:
    ...
    def test_only_hashtags_line(self) -> None:
    ...
    def test_neither_line_fallback_title(self) -> None:
    ...
    def test_title_and_hashtags_in_middle(self) -> None:
    ...
    def test_singular_hashtag_keyword(self) -> None:
        """'HASHTAG:' (singular, no trailing 's') should also match."""
        cleaned, title, hashtags = parse_title_hashtags("content\nHASHTAG: #viral")
        self.assertEqual(cleaned, "content")
        self.assertEqual(title, "content")
        self.assertEqual(hashtags, "#viral")

    def test_extra_whitespace_around_values(self) -> None:
    ...
    def test_title_before_hashtags_order_preserved(self) -> None:
    ...
    def test_multiple_title_lines_uses_last(self) -> None:
    ...
    def test_multiple_hashtags_lines_uses_last(self) -> None:
    ...
    def test_fallback_with_fewer_than_8_words(self) -> None:
    ...
    def test_colon_in_regular_text_not_mistaken(self) -> None:
    ...
    def test_empty_title_value_after_colon(self) -> None:
        """TITLE: with nothing after — title should fall back to cleaned text."""
...
class TestRetryWithBackoff(unittest.TestCase):
    """Tests for :func:`gui.llm_utils.retry_with_backoff`."""
    ...
    def test_fails_all_attempts_raises(self) -> None:
        ...
        with patch("time.sleep") as mock_sleep, self.assertRaises(ConnectionError) as ctx:
    ...
    def test_auth_error_does_not_retry(self) -> None:
        ...
        with patch("time.sleep") as mock_sleep, self.assertRaises(Exception) as ctx:
    ...
    def test_exponential_backoff_delays(self) -> None:
        ...
        with patch("time.sleep") as mock_sleep, self.assertRaises(TimeoutError):
